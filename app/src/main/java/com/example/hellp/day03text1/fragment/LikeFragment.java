...
import com.example.hellp.day03text1.adapter.RecyAdapter2;
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ArrayList<MeiBean.ResultsBean> results = (ArrayList<MeiBean.ResultsBean>) meiBean.getResults();
                        RecyAdapter2 recyAdapter2 = new RecyAdapter2(results, getActivity());
                        mRv.setAdapter(recyAdapter2);
                    }
                });
            }
        });
